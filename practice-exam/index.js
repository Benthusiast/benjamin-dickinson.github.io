...
// 6.
var firstInClass = function(array, ficObj = {}){
    if(array.length === 0){
        return ficObj;
    }
...
// 7.
var votes = dogs.reduce(function(votesSum, current){
    votesSum += current.votes;
    return votesSum;
